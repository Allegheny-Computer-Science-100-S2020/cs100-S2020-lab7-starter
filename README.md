...
`CommandLineGeometer.java` file must adhere to all of the requirements in the [Google
...
The source code in the `CommandLineGeometer.java` file must also pass additional
tests set by the [GatorGrader
tool](https://github.com/GatorEducator/gatorgrader). For instance, GatorGrader
will check to ensure that `CommandLineGeometer` produces exactly ten lines of
...
study Sections 3.1 through 3.8. To enhance your understanding of some concepts
in this laboratory assignment, such as parameter passing, you should also
examines Figures 4.7 and 4.8. Please see the course instructor or one of the
...
- The CommandLineGeometer.java in src/main/java/labseven has at least 1 of the `public class CommandLineGeometer` fragment
- The CommandLineGeometer.java in src/main/java/labseven has at least 1 of the `shape = GeometricShape.sphere;` fragment
- The CommandLineGeometer.java in src/main/java/labseven has at least 1 of the `shape = GeometricShape.triangle;` fragment
- The CommandLineGeometer.java in src/main/java/labseven has at least 20 of the `println(` fragment
- The CommandLineGeometer.java in src/main/java/labseven has at least 4 single-line Java comment(s)
- The CommandLineGeometer.java in src/main/java/labseven has exactly 0 of the `Add Your Name Here` fragment
- The CommandLineGeometer.java in src/main/java/labseven has exactly 0 of the `TODO` fragment
- The CommandLineGeometer.java in src/main/java/labseven has exactly 1 of the `import java.io.File;` fragment
- The CommandLineGeometer.java in src/main/java/labseven has exactly 1 of the `import java.io.FileNotFoundException;` fragment
- The CommandLineGeometer.java in src/main/java/labseven has exactly 1 of the `import java.util.Date;` fragment
- The CommandLineGeometer.java in src/main/java/labseven has exactly 1 of the `new Date()` fragment
- The CommandLineGeometer.java in src/main/java/labseven has exactly 1 of the `package labseven;` fragment
- The CommandLineGeometer.java in src/main/java/labseven has exactly 2 multiple-line Java comment(s)
- The command output has exactly 15 lines
- The file CommandLineGeometer.java exists in the src/main/java/labseven directory
- The file GeometricCalculator.java exists in the src/main/java/labseven directory
- The file reflection.md exists in the writing directory
- The GeometricCalculator.java in src/main/java/labseven has at least 1 of the `public class GeometricCalculator` fragment
- The GeometricCalculator.java in src/main/java/labseven has at least 4 single-line Java comment(s)
- The GeometricCalculator.java in src/main/java/labseven has exactly 0 of the `Add Your Name Here` fragment
- The GeometricCalculator.java in src/main/java/labseven has exactly 0 of the `import java.io.File;` fragment
- The GeometricCalculator.java in src/main/java/labseven has exactly 0 of the `import java.io.FileNotFoundException;` fragment
- The GeometricCalculator.java in src/main/java/labseven has exactly 0 of the `import java.util.Date;` fragment
- The GeometricCalculator.java in src/main/java/labseven has exactly 0 of the `new Date()` fragment
- The GeometricCalculator.java in src/main/java/labseven has exactly 0 of the `println(` fragment
- The GeometricCalculator.java in src/main/java/labseven has exactly 0 of the `TODO` fragment
- The GeometricCalculator.java in src/main/java/labseven has exactly 1 of the `package labseven;` fragment
- The GeometricCalculator.java in src/main/java/labseven has exactly 4 multiple-line Java comment(s)
...
```
        ┏━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┓
        ┃ Passed 35/35 (100%) of checks for cs100-S2020-lab7! ┃
        ┗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┛
```
...
```
git remote add download git@github.com:Allegheny-Computer-Science-100-S2020/cs100-S2020-lab7-starter.git
```
...
5](https://github.com/Allegheny-Computer-Science-100-S2020/cs100-S2020-lab7-starter)
repository and [raise an
issue](https://github.com/Allegheny-Computer-Science-100-S2020/cs100-S2020-lab7-starter/issues).
